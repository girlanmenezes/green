...
class DB:
    def get_conta_banco(self, day, empresa):
    ...
    def get_atendimento_banco(self, day, empresa):
        date_now = datetime.datetime.now()
        date_retroativa = date_now - datetime.timedelta(days=day)
